...
class ProductosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_poructos)
    ...
    fun agregarProductos(option: String?) {
        ...
        when (option) {
            "antojitos" -> {
                ...
                menu.add(Product("Huracanes", R.drawable.huaraches, "Tortilla gruesa con frijoles, tu carne favorita, lechuga, queso fresco y crema. Big Thick tortilla with beans, your choice of meat, fresh cheese, and sour cream",10.85))
            ...
            "especialidades" -> {
                ...
                menu.add(Product("Coctel de camaron", R.drawable.coctel, "",14.50))
            }

            "combinations" -> {
                imgA.setImageResource(R.drawable.combinations)
                menu.add(Product("Tradicional Taco Combo", R.drawable.combinationtaco, "Tortilla de Maiz, tu carne favorita, servido con arroz y frijoles Corn tortilla taco, your choice of meat, served with rice and beans",6.99))
            ...
            "tortas" -> {
                ...
                menu.add(Product("Torta Cubana", R.drawable.tortacubana, "\n" +
                        "Chorizo, asada, jamon, pastor y queso Mexican sausage, steak, marinated pork, ham, and cheese",13.59))
            ...
            "drinks" -> {
                ...
                menu.add(Product("Aguas Frescas", R.drawable.antojitos, "",2.99))
                ...
                menu.add(Product("Lata Beer", R.drawable.antojitos, "",2.99))
                menu.add(Product("Charolazo", R.drawable.charolazo, "",15.75))
                menu.add(Product("Carolazo con camarones", R.drawable.antojitos, "",21.99))
                menu.add(Product("La mamalona", R.drawable.antojitos, "(Michelada 2 cervesas)",12.99))
                menu.add(Product("La mamlona con camarones", R.drawable.antojitos, "",14.99))
